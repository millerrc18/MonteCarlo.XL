...
public class TaskPaneHost : UserControl
{
    ...
    /// <summary>
    /// Gets the MainViewModel that drives the task pane UI.
    /// Used by the Addin layer to wire events between UI and Excel.
    /// </summary>
    public MainViewModel MainViewModel => (MainViewModel)_wpfControl.DataContext;
